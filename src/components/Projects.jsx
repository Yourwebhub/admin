...
const projects = [
  { type: "Wordpress", title: "Realestate project", img: "/projects/1.png", summary: "This is a brief description of Project One.", link: "https://actindustrial.co.uk/" },
  { type: "React", title: "Cosmetic project", img: "/projects/2.png", summary: "This is a brief description of Project Two.", link: "https://project-two.com" },
    ...
    <article className="w-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light dark:border-light dark:bg-dark p-4 relative">
      ...
      <div className="w-full flex flex-col items-start justify-between mt-4">
        ...
        <div className="w-full mt-2 flex items-center justify-between">
          <Link className="text-lg font-semibold dark:text-light underline" href={link} target="_blank">Visit</Link>
        </div>
      </div>
    </article>
  );
